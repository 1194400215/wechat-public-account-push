...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx786b8d6cb4f2a19f ',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '618480c5e8a54d61ff1446b84de73d0c',
   ...
   */
  USERS: [om3lU6ols0FqxiD5BxuHkW95CpiE
    {
      // 想要发送的人的名字
      name: '悦宝',
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: 'om3lU6ols0FqxiD5BxuHkW95CpiE',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: '1qa15xMKSpYxEJnGAVaNi4DDiKOxzbY0vUMwNLkVUO0	',
      // 所在省份
      province: '陕西',
      // 所在城市
      city: '西安',
      ...
      festivals: [
        ...
        {
          type: '生日', name: '悦宝', year: '1998', date: '09-26',
        },
        {
  ...
  CALLBACK_TEMPLATE_ID: '1qa15xMKSpYxEJnGAVaNi4DDiKOxzbY0vUMwNLkVUO0',
